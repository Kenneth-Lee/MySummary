...
为了让复杂的抽象概念可以总有个具象作为参照，我们用一个人人都能理解的实例作为我
们讨论抽象问题的参照例子。
...
比如“一只黄色的猫”，“一只白色的猫”，“一只短尾巴的猫”，这些具象，我们抽象为“一只
...
如果用数学来理解，一个具象，相当于一个包含了所有参数的“结果”，比如，我们可以类
...
15和20是我们的“目标”，具象是达成目标的所有细节。而抽象，就相当于我们把向量的部
